...
Before redirecting, the Experiment reads the source MIME and requires both a
`message/rfc822` root and a nested encrypted S/MIME (`pkcs7-mime`,
`smime-type=enveloped-data`) entity. Ordinary messages, including messages with normal file
